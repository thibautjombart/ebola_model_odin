---
title: A stochastic meta-population model of Ebola virus disease transmission
...
Run this code if you need to install the libraries used in this script. You normally need to do this only once:
```{r}
...
Here we illustrate a single model run for 365 days (one run takes about 10-20s on a standard desktop). 
